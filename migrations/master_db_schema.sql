-- master_db schema: station observations + polymarket archive tables
...
CREATE TABLE IF NOT EXISTS station_observations (
    ...
    PRIMARY KEY (station, observed_at_local)
);

CREATE INDEX IF NOT EXISTS station_observations_station_idx
    ON station_observations(station);
